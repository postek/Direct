...
public class NeighbourListFragment extends ListFragment implements WifiP2pManager.PeerListListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mContentView = inflater.inflate(R.layout.neighbour_list, null);
        return mContentView;
    }
